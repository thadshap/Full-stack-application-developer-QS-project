...
export default {
  ...
  getTrueIfLoginSuccess(email, password, typeOfUser) {
    return apiClient.post("/person/login", {
      email: email,
      password: password,
  ...
  getPronouns(userId, typeOfUser) {
    return apiClient.post("/person/getPronouns", {
      id: userId,
      typeOfUser: typeOfUser,
    });
  },
  ...
  deleteStudentFromCourse(courseId, email) {
    return apiClient.post("/courses/removeStudent", {
      courseId: courseId,
      email: email,
    });
  },
  ...
  getAllAssignmentsInCourseForStudentAndIfApproved(courseId, studentId) {
    return apiClient.post("/queues/newSiq", {
      courseId: courseId,
      id: studentId,
    });
  },
  ...
  postStudentInQueue(
    ...
    return apiClient.post("/courses/queue", {
      courseId: courseId,
      id: userId,
      digital: typeOfLocation,
      assessmentHelp: helpOrApproving,
      campus: campus,
      building: building,
      room: room,
      tableNumber: table,
  ...
  changeTypeOfActiveQueue(courseId, activeBoolean) {
    return apiClient.post("/courses/queue/status", {
      courseId: courseId,
  ...
  approveAssignmentForStudent(courseId, userId, assignmentNumber) {
    return apiClient.post("/students/assignments", {
      courseId: courseId,
      id: userId,
  ...
  changeStateInQueueForStudent(userId, courseId, state) {
    return apiClient.post("/students/queue/changeState", {
      courseId: courseId,
      id: userId,
      statusInQueue: state,
    });
  ...
  deleteStudentFromQueue(userId, courseId) {
    return apiClient.post("/courses/queue/deleteStudent", {
      courseId: courseId,
      id: userId,
    });
  },
