<template>
  ...
  <div id="settingsContainer">
    ...
    Navnet ditt:
    <input id="name" class="inputFields" type="text" v-model="name" disabled />
    <br>
    Emailen din:
    <input
      id="email"
    ...
    <br>
    <p>
      Dine foretrukne pronomen:
      <input id="pronouns" class="inputFields" type="text" v-model="pronouns" />
      <br>
      <button id="changePronouns" v-on:click="postPronomen">
        Change pronouns
      </button>
    </p>
  </div>
